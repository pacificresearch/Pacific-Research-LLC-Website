...
story.append(Paragraph(
    ...
    "and financial dimensions of funded clinical trials — budgeting, billing, and feasibility management; "
...
stanford_bullets = [
    "Served as a day-to-day liaison between principal investigators, sponsors, and CROs on regulatory, "
    ...
    "hospital, and sponsor requirements to day-to-day financial and operational decisions.",
    "Interpreted and explained protocol, institutional, and sponsor requirements to study teams; served as "
    "the day-to-day escalation point for study procedures and documentation standards.",
    ...
    "Trained and onboarded incoming clinical research coordinators on protocol workflows, eConsent, ePRO, and "
    "REDCap/OnCore data entry; developed study-specific training materials.",
...
job(story,
    ...
    [
        ...
        "time per patient from 30 to approximately 18 minutes (40% faster) — a Lean-style process "
        "improvement delivered under intense operational pressure — and trained staff and interagency "
...
job(story,
    ...
    [
        ...
        "sustaining Joint Commission and DoD accreditation readiness — disciplined stewardship of high-value "
        "institutional assets under external regulatory scrutiny.",
        ...
        "cross-disciplinary teams and achieving zero equipment-related incidents — a demonstrated commitment "
        "to safety communication and safe behaviors.",
    ])
